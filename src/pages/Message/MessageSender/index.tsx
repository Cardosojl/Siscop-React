...
import '../components/Jodit/Jodit.styles.css';
import { MessageTypes, ProcessTypes } from 'src/apis/types';
...
import joditConfig from '../components/Jodit/joditConfig';
...
function MessageSender(): JSX.Element {
    ...
    const [form, setForm] = useState<Partial<MessageTypes> & Partial<ProcessTypes>>({ title: undefined, sender: undefined, content: undefined });
